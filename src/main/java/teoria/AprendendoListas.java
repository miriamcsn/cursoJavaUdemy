...
public class AprendendoListas {
    ...
    public static void main(String[] args) {
        ...
        List<String> list = new ArrayList<>();  // <> => generics | arraylist pega as boas caract de arrays e vetores
        ...
        // remover to do mundo que começa com a letra M:
         ...
         * Primeiro, temos que converter para o tipo stream() a lista original que contem os elementos
         ...
         * então tem q ser feita a conversao pela funcao collect que converte pra tipo Lista.
         * */
        System.out.println("----------------------");
        ...
        System.out.println(name);  // retorna Alex (1a ocorrencia de um nome com a letra A)
