...
public class AprendendoProcessamentoDados {
    ...
    public static void main(String[] args) {
        ...
        double b, B, h, area;
        b = 6.0;  // quando é double (ponto flutuante de precisão dupla), coloca-se o .0 para indicar que é do tipo double
        B = 8.0;
        h = 5.0;
        area = (b + B) / 2.0 * h;
        ...
        b2 = 6f;  // quando é float (ponto flutuante de precisão simples), coloca-se o f para indicar que é do tipo float
        B2 = 8f;
        h2 = 5f;
